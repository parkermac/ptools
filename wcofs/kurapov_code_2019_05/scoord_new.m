function [z,sc,Cs]=scoord_new(h,zeta,theta_s,theta_b,Tcline,N,kgrid,column,index,Vtransform,Vstretching,plt);

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Copyright (c) 1996 Rutgers University.                                    %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                                                                           %
% function [z,sc,Cs]=scoord_new(h,theta_s,theta_b,Tcline,N,kgrid,column,index   %
...
elseif Vstretching==4
  if (kgrid == 1),
   ...
   for k=N:-1:1
    sc(k)=ds*(k-N);
    if theta_s>0
        Csur=(1-cosh(theta_s*sc(k)))./(cosh(theta_s)-1);
    else
        Csur=-sc(k).^2;
    end
    if theta_b>0
