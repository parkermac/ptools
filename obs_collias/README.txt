README for obs_collias

This is for processing the Collias dataset of historical CTD-Bottle data for Puget Sound.
...
Output: ptools_output/collias/region_[1-8].py which are DataFrames containing data like:
            Temp. (deg C)  Salinity  DO (mg L-1)  NO3 (mg L-1)  NO2 (mg L-1)  SiOH4 (mg L-1)  Z (m)
Date                                                                                               
1932-07-07      10.560000    29.006     7.132000       0.17700      0.006776          0.9998    -30
1932-07-07      11.200000    28.300     7.570000           NaN           NaN          0.9830    -10
1932-07-07      13.800000    23.170     9.920000           NaN           NaN          0.4780      0
1932-11-04      10.806000    30.120     5.340000           NaN           NaN          0.8710    -30
1932-11-04      10.800000    30.050     6.340000           NaN           NaN          0.8710    -10
1932-11-04      10.790000    30.030     5.170000           NaN           NaN          0.8710      0
...
Output: ptools_output/collias/region_month_z_means.py which is a dict: A_dict[region] = (A0, A10, A30), numbered by depth, and each with data like
           Temp. (deg C) Salinity DO (mg L-1) NO3 (mg L-1) NO2 (mg L-1) SiOH4 (mg L-1)
1932-01-15           NaN      NaN         NaN          NaN          NaN            NaN
1932-02-15           NaN      NaN         NaN          NaN          NaN            NaN
1932-03-15           NaN      NaN         NaN          NaN          NaN            NaN
1932-04-15           NaN      NaN         NaN          NaN          NaN            NaN
1932-05-15           NaN      NaN         NaN          NaN          NaN            NaN
1932-06-15          13.2    27.92        8.69        0.084      0.00392          0.787
1932-07-15       12.7167  26.6167        9.01      0.09825     0.004655         0.8372

So this is a time series with 12 values per year, at mid month.
